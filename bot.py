...
def start(message):
    ...
    bot.send_video(message.chat.id, "https://t.me/VIPABH/1168", caption=f" اهلا [{message.from_user.first_name}](https://t.me/{username}) حياك الله! اضغط على الزر لبدء اللعبة.", parse_mode="Markdown", reply_markup=markup)
